...
public final class ToastUtils {
    ...
    private static int yOffset = (int) (64 * ContextProvider.getContext().getResources().getDisplayMetrics().density + 0.5);
    ...
    public static void setView(@LayoutRes int layoutId) {
        LayoutInflater inflate = (LayoutInflater) ContextProvider.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    public static void showShort(@StringRes int resId) {
        showShort(resId, true);
    }

    private static boolean hasCustomToastView() {
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            return view != null;
        }
    ...
    private static void show(@StringRes int resId, int duration) {
        show(ContextProvider.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes int resId, int duration, Object... args) {
        show(String.format(ContextProvider.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(CharSequence text, int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(ContextProvider.getContext());
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(ContextProvider.getContext(), spannableString, duration);
            } else {
                sToast = Toast.makeText(ContextProvider.getContext(), text, duration);
            }
        }
